export const CARD_BG = [
  ...
  { id: 9, bgcolor: 'linear-gradient(135deg, #f0ecf2 0%, #fff8f8 100%)' },
...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas — no one-size-fits-all approach here!",
  },
  {
    id: "02",
